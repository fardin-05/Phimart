...
class EmptySerializer(serializers.Serializer):
    pass
class SimplifyProductSerializer(serializers.ModelSerializer):#Why did we use SimplifyProductSerializer!!! Because we don't need all the values ​​of the product model, we only need the name and price for our cart items.
    class Meta :
        model = Product
